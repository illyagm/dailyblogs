...
const graphcms = new GraphQLClient(
  process.env.NEXT_PUBLIC_HYGRAPH_PROJECT_API_URL,
  {
    headers: {
        ...
        <main className={styles.blog}>
          <Row>
            <Col md="9">
              <div className={styles.text}>
                ...
                <div className={styles.legalnotice}>
                  ⚙️ Este post fue creado utilizando inteligencia artificial
                  como herramienta de redacción. Su contenido ha sido revisado,
                  corregido y validado manualmente antes de su publicación.
                </div>
            ...
            <Col className="ledgerComponentSlug justify-content-start">
              <a
                href="https://shop.ledger.com/pages/ledger-nano-s-plus/?r=a77d8a211939"
                target="_blank"
              ...
              >
                <img
                  width="160"
                  height="600"
                  src="https://affiliate.ledger.com/image/160/600/Spanish"
                />
              </a>
            </Col>
          </Row>
